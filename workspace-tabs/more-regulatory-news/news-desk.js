(function () {
  const newsItems = [
    {
      id: "uk-duaa-complaints-2026",
      title: "英国 DUAA 数据保护投诉处理义务即将生效",
      source: "ICO",
      sourceType: "监管机构官网",
      jurisdiction: "英国",
      topic: "数据保护",
      ...
      url: "https://ico.org.uk/about-the-ico/media-centre/news-and-blogs/2026/05/one-month-to-go-what-businesses-need-to-know-to-meet-new-data-law/",
      summary: "英国 ICO 提醒组织需在 2026 年 6 月 19 日前建立数据保护投诉处理流程，以满足《Data (Use and Access) Act 2025》的新要求。",
      relatedLaw: "Data (Use and Access) Act 2025",
      relatedArticles: ["Section 103", "DPA 2018 Section 164A", "UK GDPR"],
      scenarios: ["数据主体投诉入口", "DSAR 争议处理", "Cookie 与营销投诉", "安全事件投诉"],
      impact: "高",
      valueScore: 93,
      duplicateRisk: 9,
      recommendedAction: "建议英国业务团队立即检查投诉入口、响应时限、升级路径和留痕模板。"
    },
    {
      id: "edpb-scientific-research-2026",
      title: "EDPB 科学研究个人数据处理指南征求意见临近截止",
      source: "EDPB",
      sourceType: "监管机构指南",
      jurisdiction: "欧盟",
      topic: "数据保护",
      ...
      summary: "EDPB Guidelines 1/2026 聚焦科学研究场景下的个人数据处理，覆盖合法基础、同意、控制者/处理者关系和数据主体权利。",
      relatedLaw: "GDPR / EDPB Guidelines 1/2026",
      relatedArticles: ["GDPR Art. 5", "GDPR Art. 6", "GDPR Art. 9", "GDPR Art. 89"],
      scenarios: ["车联网研发数据分析", "医学与健康研究", "匿名化与假名化", "研究数据二次利用"],
      impact: "高",
      valueScore: 90,
      duplicateRisk: 14,
      recommendedAction: "建议研发、法务和数据治理团队复核研究数据合法基础、二次利用边界和权利响应流程。"
    },
    {
      id: "eu-high-risk-ai-guidelines-2026",
      title: "欧委会高风险 AI 系统分类指南征询进入最后阶段",
      ...
      summary: "欧委会就 AI Act 高风险 AI 系统分类指南征询意见，帮助提供者和部署者判断系统是否落入高风险类别及对应义务。",
      relatedLaw: "Regulation (EU) 2024/1689",
      relatedArticles: ["Art. 6", "Art. 6(5)", "Annex I", "Annex III"],
      scenarios: ["车载辅助驾驶算法", "员工管理 AI", "信用与风险评分", "公共服务自动化决策"],
      impact: "高",
      valueScore: 92,
      duplicateRisk: 11,
      recommendedAction: "建议 AI 产品团队把现有用例映射到 Annex I/III，并准备高风险分类判断记录。"
    },
    {
      id: "eu-ai-generated-content-code-2026",
      title: "欧盟发布 AI 生成内容透明度实践守则",
      source: "European Commission",
      sourceType: "欧盟官方守则",
      jurisdiction: "欧盟",
      topic: "人工智能",
      ...
      summary: "该实践守则支持 AI Act 第 50 条透明度义务，围绕 AI 生成或操纵内容的标记、检测和深度伪造标签提供合规路径。",
      relatedLaw: "Regulation (EU) 2024/1689",
      relatedArticles: ["Art. 50(2)", "Art. 50(4)", "Art. 50(5)"],
      scenarios: ["生成式 AI 内容发布", "深度伪造标识", "AI 客服内容披露", "媒体内容标记"],
      impact: "高",
      valueScore: 88,
      duplicateRisk: 17,
      recommendedAction: "建议生成式 AI 应用补充内容标记策略、检测流程和用户侧披露提示。"
    },
    {
      id: "edpb-breach-template-2026",
      title: "EDPB 发布个人数据泄露通知模板并征求意见",
      source: "EDPB",
      sourceType: "监管机构模板",
      jurisdiction: "欧盟",
      topic: "网络安全",
      ...
      language: "EN",
      publishedAt: "2026-06-10",
      url: "https://www.edpb.europa.eu/our-work-tools/documents/public-consultations/2026/template-personal-data-breach-notification_en",
      summary: "EDPB 个人数据泄露通知模板面向监管机构 IT 工具实施，纳入必要字段、预设值和提示语，以提升泄露通报一致性。",
      relatedLaw: "GDPR / EDPB breach notification template",
      relatedArticles: ["GDPR Art. 33", "GDPR Art. 34"],
      scenarios: ["个人数据泄露通报", "安全事件分级", "监管报送字段", "事件处置留痕"],
      impact: "中",
      valueScore: 84,
      duplicateRisk: 18,
      recommendedAction: "建议安全与隐私团队对照模板检查现有事件通报字段、审批节点和监管报送口径。"
    },
    {
      id: "eu-ai-act-2024",
